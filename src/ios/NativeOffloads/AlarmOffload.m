...
static NSString *const HELP_TEXT =
    @"apple-alarm - Set alarms and timers on iOS (AlarmKit, iOS 26+)\n"
     ...
     "\n"
     "DEEP LINK:\n"
     "  minis://views/alarm              Open the alarm management page in MinisX\n";
    ...
    if (!authorized) {
        NSString *msg = authError
            ? [NSString stringWithFormat:@"AlarmKit authorization failed: %@. "
                "To grant access, open Settings > Privacy & Security > Alarms and enable MinisX.",
...
static int cmd_set_alarmkit(int argc, char **argv, int stdout_fd,
    ...
    if (@available(iOS 26.0, *)) {
        ...
        data[@"hint"] = @"Alarm is now visible on the MinisX home screen. Open minis://views/alarm to manage alarms.";
...
static int cmd_timer_alarmkit(int argc, char **argv, int stdout_fd,
    ...
    if (@available(iOS 26.0, *)) {
        ...
        data[@"view_url"] = @"minis://views/alarm";
        data[@"hint"] = @"Timer is now visible on the MinisX home screen. Open minis://views/alarm to manage alarms.";
