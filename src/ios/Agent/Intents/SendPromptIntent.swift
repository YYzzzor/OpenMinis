...
struct SendPromptIntent: AppIntent {
    ...
    static var description = IntentDescription("Sends a prompt to the MinisX AI agent. Returns session info immediately while the task runs in the background.")
    ...
    @Parameter(title: "Prompt",
               requestValueDialog: "What would you like to ask MinisX?",
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<SendPromptResult> & ProvidesDialog {
        ...
        if sendCompletionNotification {
            ...
            ShortcutNotification.post(
                ...
                title: AppLocalized("MinisX Task Started"),
        ...
        if waitForResult {
            ...
            if sendCompletionNotification {
                ShortcutNotification.post(
                    ...
                    title: AppLocalized("MinisX Task Completed"),
