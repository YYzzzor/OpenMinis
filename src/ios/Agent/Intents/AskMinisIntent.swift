...
struct AskMinisIntent: AppIntent {
    static var title: LocalizedStringResource = "Ask MinisX"
    static var description = IntentDescription("Opens MinisX, sends your prompt, and shows the conversation. Starts a new session, or continues an existing one when you pick a session.")
    ...
    @Parameter(title: "Prompt", requestValueDialog: "What would you like to ask MinisX?")
    var prompt: String
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        return .result(dialog: "On it — opening MinisX.")
    }
}
