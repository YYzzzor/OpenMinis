...
struct FollowUpSessionIntent: AppIntent {
    ...
    static var description = IntentDescription("Sends a follow-up prompt to an existing MinisX session, continuing the conversation with the AI agent.")
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<SendPromptResult> & ProvidesDialog {
        ...
        if sendCompletionNotification {
            ...
            ShortcutNotification.post(
                ...
                title: AppLocalized("MinisX: Follow-up Sent"),
        ...
        if waitForResult {
            ...
            if sendCompletionNotification {
                ShortcutNotification.post(
                    ...
                    title: AppLocalized("MinisX: Follow-up Done"),
