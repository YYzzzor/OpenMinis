...
enum AudioTogglePlaybackBridge {
    ...
    static let darwinNotificationName = "com.yyzzzor.minisx.liveActivity.audioToggle"
}
...
struct AudioTogglePlaybackIntent: LiveActivityIntent {
    ...
    static var description = IntentDescription("Toggles play/pause on MinisX audio narration from the Live Activity.")
