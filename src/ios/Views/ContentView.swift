...
struct ContentView: View {
    ...
    @State private var soulName: String = SoulStore.cachedMetadata.displayName
    ...
    private var navigationEventContent: some View {
        startupContent
    ...
    // 启动加载独立于 View 表达式，保留原有异步顺序和任务生命周期。
    @MainActor
    private func loadInitialSessionState() async {
