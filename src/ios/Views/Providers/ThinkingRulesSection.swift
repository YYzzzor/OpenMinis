    ...
    private var unsupportedNoticeSection: some View {
        Section {
            HStack(alignment: .firstTextBaseline, spacing: 8) {
                ...
                Text("This provider uses an official protocol, so its thinking parameters are maintained by MinisX. Custom rules apply to OpenAI-compatible providers on the Chat Completions API.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            }
        } header: {
