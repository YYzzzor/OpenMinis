...
struct MinisApp: App {
    ...
    private static let fileProviderDomain = NSFileProviderDomain(
        identifier: NSFileProviderDomainIdentifier("com.yyzzzor.minisx.files"),
        displayName: "MinisX"
    )
    ...
    private static func logAppUpdateMarkerForFPTrace() {
        ...
        guard let container = fm.containerURL(forSecurityApplicationGroupIdentifier: "group.com.yyzzzor.minisx") else { return }
    ...
    private static func migrateSharedDirToAppGroup() {
        ...
        let container = fm.containerURL(forSecurityApplicationGroupIdentifier: "group.com.yyzzzor.minisx")!
    ...
    private static func logFPSyncTracePaths() {
        let fm = FileManager.default
        let groupID = "group.com.yyzzzor.minisx"
